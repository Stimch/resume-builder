      ...
      return function() {
        var __webpack_modules__ = { 3312: function(e, t, n) {
          ...
          function X(e2) {
            ...
            else if (F2) ee(e2) && (e2 = Object.getPrototypeOf(e2)), p2 = l2 ? Object.getOwnPropertyNames(e2) : Object.keys(e2), A2 ? (t2 = 1, u2 = "{", _()(p2, z2), u2 += h2.join(", ") + m2 + "}") : "Object" === (u2 = M(e2)) && (u2 = "{…}");
            else if (R2) u2 = e2 + "", u2 = C()(u2, "Infinity") || "NaN" === u2 ? '"'.concat(u2, '"') : x2 + u2 + j2;
          ...
          var Le = function(e2) {
            ...
            return (0, l.A)(t2, e2), (0, i.A)(t2, [{ key: "set", value: function(e3) {
              ...
              if (null === t3) return "<li>".concat(h2(e3), '<span class="').concat(i2("null"), '">null</span></li>');
              if (f()(t3) || v()(t3)) return "<li>".concat(h2(e3), '<span class="').concat(i2(a2), '">').concat(se(t3), "</span></li>");
              if ("RegExp" === t3.type && (a2 = "regexp"), "Number" === t3.type && (a2 = "number"), "Number" === t3.type || "RegExp" === t3.type) return "<li>".concat(h2(e3), '<span class="').concat(i2(a2), '">').concat(se(t3.value), "</span></li>");
              if ("Undefined" === t3.type || "Symbol" === t3.type) return "<li>".concat(h2(e3), '<span class="').concat(i2("special"), '">').concat(g()(t3.type), "</span></li>");
              if ("(...)" === t3) return "<li>".concat(h2(e3), '<span class="').concat(i2("special"), '">').concat(t3, "</span></li>");
              if (y()(t3)) {
          ...
          var Ge = function(e2) {
            ...
            return (0, l.A)(t2, e2), (0, i.A)(t2, [{ key: "set", value: function(e3) {
              ...
              if (f()(n2) || v()(n2)) return "<li>".concat(A2(e3), '<span class="').concat(s2(c2), '">').concat(se(n2), "</span></li>");
          ...
          function Ln(e2) {
            ...
            if (e2.nodeType === Node.TEXT_NODE) return '<span class="'.concat(ze("tag-name-color"), '">(text)</span>');
            if (e2.nodeType === Node.COMMENT_NODE) return '<span class="'.concat(ze("tag-name-color"), '"><!--></span>');
            ...
            return (0, s.A)(t2, e2), (0, r.A)(t2, [{ key: "init", value: function(e3, n2) {
              ...
              Kn(t2, "init", this, 3)([e3]), this._container = n2, this._initTpl(), this._htmlEl = document.documentElement, this._detail = new Pn(this._$detail, n2), this.config = this._detail.config, this._splitMediaQuery = new (en())("screen and (min-width: 680px)"), this._splitMode = this._splitMediaQuery.isMatch(), this._domViewer = new vn.A(this._$domViewer.get(0), { node: this._htmlEl, ignore: function(e4) {
                return Ie(e4) || function(e5) {
                  for (; e5; ) {
                    var t3 = "";
                    if (e5.getAttribute && (t3 = e5.getAttribute("class") || ""), O()(t3, "__chobitsu-hide__")) return true;
                    e5 = e5.parentNode;
                  }
                  return false;
                }(e4);
              ...
              var e3 = function(e4) {
                var t4 = [], n2 = 0;
                for (; e4; ) t4.push({ text: Ln(e4, { noAttr: true }), idx: n2++ }), pn()(e4) && (e4 = e4.host), e4 = !e4.parentElement && pn()(e4.parentNode) ? e4.parentNode : e4.parentElement;
                return t4.reverse();
              }(this._curNode), t3 = "";
          ...
          var So = function() {
            return (0, r.A)(function e2(t2, n2) {
              ...
              for (var t2 = Wt.domain("Network").getCookies().cookies, n2 = 0, o2 = t2.length; n2 < o2; n2++) if (t2[n2].name === e2) return t2[n2].value;
              return "";
            } }, { key: "_bindEvent", value: function() {
              var e2 = this, t2 = this._devtools;
              function n2(e3, n3) {
          ...
          Object.defineProperty(t, "__esModule", { value: true }), t.enable = function() {
            ...
            } else t2 = document.createElement("div"), e2.appendChild(t2), x || ((0, f.default)(S), x = true);
          ...
          t = o({ initialize: function(e2) {
            ...
            if (n2 = e2.match(l)) for (n2 = n2[1], t2 = 0; t2 < 3; t2++) o2[t2] = parseInt(n2[t2] + n2[t2], 16);
              ...
              n2[4] && (o2[3] = parseFloat(n2[4]));
            } else (n2 = e2.match(f)) && (r2 = "hsl", o2 = [(parseFloat(n2[1]) % 360 + 360) % 360, i(parseFloat(n2[2]), 0, 100), i(parseFloat(n2[3]), 0, 100), i(parseFloat(n2[4]), 0, 1)]);
          ...
          function M(e2, t2) {
            ...
            if ("Undefined" !== r2) {
              ...
              else if ("RegExp" === r2) p2 = (f2 = a2).lastIndexOf("/"), h2 = new RegExp(f2.slice(1, p2), f2.slice(p2 + 1));
              else {
                var v2;
